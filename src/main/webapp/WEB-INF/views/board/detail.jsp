				            ...
				            <div class="card shadow mb-4">
				                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				                    <h6 class="m-0 font-weight-bold text-primary">
				                        ${detail.boardNum}. ${detail.boardTitle}
				                    </h6>
				                    <div class="dropdown no-arrow">
				                       <span class="small text-gray-500 mr-3">작성일: ${detail.boardDate}</span>
				                       <span class="small text-gray-500">조회수: ${detail.boardHit}</span>
				                    </div>
				                </div>
				                <div class="card-body">
				                    <div class="mb-3">
				                        <label class="small font-weight-bold text-gray-800">작성자</label>
				                        <span class="ml-2">${detail.boardWriter}</span>
				                    </div>
