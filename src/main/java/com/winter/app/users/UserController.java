...
public class UserController {
	...
	@GetMapping("update")
	public void update(HttpSession session, Model model,  @AuthenticationPrincipal UserDTO userDTO)throws Exception{
...
//		if(result > 0) {
//			// DB에서 사용자를 조회 해야 함
//			UsernamePasswordAuthenticationToken to = new UsernamePasswordAuthenticationToken(userDTO, authentication.getCredentials());
